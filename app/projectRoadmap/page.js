...
export default function Page() {
    ...
    const fetchChats = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/roadmap-chats/`, { withCredentials: true });
    ...
    const fetchMessages = async (chatId) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/roadmap-chats/${chatId}/messages/`, { withCredentials: true });
    ...
    const handleSendMessage = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`${API_BASE_URL}/roadmap-chats/${activeChat}/messages/`, {
                text: inputValue,
    ...
    const handleNewChat = async () => {
        try {
            const response = await axios.post(`${API_BASE_URL}/roadmap-chats/`, {
    ...
    return (
        <div className="flex flex-row w-full h-screen bg-gray-50">
            ...
            <main className="w-4/5 flex flex-col p-4">
                <div className="chat-content flex-grow overflow-y-auto mb-4 p-4 bg-white rounded-lg shadow-sm">
